        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-5 offset-xl-1">
                ...
                if ($_SESSION["error"]) {
                    ...
                    <i class="bi bi-exclamation-triangle bi-danger me-1"></i>
                    ' . $_SESSION["error"] . '
                  </div>';
                ...
                <form action="controllers/login-controller.php" method="POST">
                    ...
                    <div class="form-outline mb-2">
                        ...
                        <input type="email" id="form3Example2" name="email" class="form-control form-control-lg" placeholder="Enter a valid email address" />
                    </div>
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        <button type="submit" class="btn btn-primary btn-sm w-50" style="padding-left: 2.5rem; padding-right: 2.5rem;">Login</button>
